import {
  ...
  require_sortBy,
  require_toInteger
} from "./chunk-LN6UUXUC.js";
import {
  require_prop_types
} from "./chunk-NZSD342S.js";
import {
  clsx_default
...
var require_chunk = __commonJS({
  "../../node_modules/lodash/chunk.js"(exports, module) {
    ...
    function chunk2(array, size3, guard) {
      if (guard ? isIterateeCall(array, size3, guard) : size3 === void 0) {
        size3 = 1;
      } else {
      ...
      var index = 0, resIndex = 0, result = Array(nativeCeil(length / size3));
      while (index < length) {
        result[resIndex++] = baseSlice(array, index, index += size3);
      }
      return result;
    }
...
// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/ownerDocument.js
function ownerDocument(node) {
  return node && node.ownerDocument || document;
}

// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/ownerWindow.js
function ownerWindow(node) {
  const doc = ownerDocument(node);
  return doc && doc.defaultView || window;
}

// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/getComputedStyle.js
function getComputedStyle(node, psuedoElement) {
  return ownerWindow(node).getComputedStyle(node, psuedoElement);
}

// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/hyphenate.js
var rUpper = /([A-Z])/g;
function hyphenate(string) {
  return string.replace(rUpper, "-$1").toLowerCase();
}

// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/hyphenateStyle.js
var msPattern = /^ms-/;
function hyphenateStyleName(string) {
  return hyphenate(string).replace(msPattern, "-ms-");
}

// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/isTransform.js
var supportedTransforms = /^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i;
function isTransform(value) {
  return !!(value && supportedTransforms.test(value));
}

// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/css.js
...
// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/contains.js
function contains(context, node) {
  if (context.contains) return context.contains(node);
  if (context.compareDocumentPosition) return context === node || !!(context.compareDocumentPosition(node) & 16);
}

// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/isDocument.js
function isDocument(element) {
  return "nodeType" in element && element.nodeType === document.DOCUMENT_NODE;
}

// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/isWindow.js
...
// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/getScrollAccessor.js
function getscrollAccessor(offset3) {
  const prop = offset3 === "pageXOffset" ? "scrollLeft" : "scrollTop";
...
// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/scrollLeft.js
var scrollLeft_default = getscrollAccessor("pageXOffset");

// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/scrollTop.js
var scrollTop_default = getscrollAccessor("pageYOffset");

// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/offset.js
...
// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/offsetParent.js
var isHTMLElement = (e) => !!e && "offsetParent" in e;
...
// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/position.js
...
function position(node, offsetParent2) {
  ...
  if (css_default(node, "position") === "fixed") {
    ...
    const parent = offsetParent2 || offsetParent(node);
    offset3 = offset(node);
    if (nodeName(parent) !== "html") parentOffset = offset(parent);
    const borderTop = String(css_default(parent, "borderTopWidth") || 0);
    parentOffset.top += parseInt(borderTop, 10) - scrollTop_default(parent) || 0;
    const borderLeft = String(css_default(parent, "borderLeftWidth") || 0);
    parentOffset.left += parseInt(borderLeft, 10) - scrollLeft_default(parent) || 0;
  }
  const marginTop = String(css_default(node, "marginTop") || 0);
  const marginLeft = String(css_default(node, "marginLeft") || 0);
  return {
    ...offset3,
...
// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/canUseDOM.js
var canUseDOM_default = !!(typeof window !== "undefined" && window.document && window.document.createElement);

// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/animationFrame.js
var prev = (/* @__PURE__ */ new Date()).getTime();
function fallback(fn3) {
  const curr = (/* @__PURE__ */ new Date()).getTime();
  const ms = Math.max(0, 16 - (curr - prev));
  const handle = setTimeout(fn3, ms);
  prev = curr;
  return handle;
}
...
function matches(node, selector) {
  if (!matchesImpl) {
    ...
    matchesImpl = function matchesImpl3(n, s) {
...
var canUseDOM_default2 = !!(typeof window !== "undefined" && window.document && window.document.createElement);
...
function contains3(context, node) {
  if (context.contains) return context.contains(node);
  if (context.compareDocumentPosition) return context === node || !!(context.compareDocumentPosition(node) & 16);
}
...
var ownerDocument_default = (function(componentOrElement) {
  return ownerDocument2(safeFindDOMNode(componentOrElement));
});
...
function useRootClose(ref, onRootClose, _temp) {
  ...
  var handleMouseCapture = (0, import_react14.useCallback)(function(e) {
    ...
    preventMouseRootCloseRef.current = !currentTarget || isModifiedEvent(e) || !isLeftClickEvent(e) || !!contains3(currentTarget, (_e$composedPath$ = e.composedPath == null ? void 0 : e.composedPath()[0]) != null ? _e$composedPath$ : e.target);
  }, [ref]);
...
function style2(node, property) {
  ...
  var transforms = "";
  if (typeof property === "string") {
    return node.style.getPropertyValue(hyphenateStyleName2(property)) || getComputedStyle3(node).getPropertyValue(hyphenateStyleName2(property));
  }
...
function isDocument2(element) {
  return "nodeType" in element && element.nodeType === document.DOCUMENT_NODE;
}

// ../../node_modules/dom-helpers/esm/isWindow.js
function isWindow2(node) {
  if ("window" in node && node.window === node) return node;
  if (isDocument2(node)) return node.defaultView || false;
  return false;
}
...
function bodyIsOverflowing(node) {
  var doc = isWindow2(node) ? ownerDocument2() : ownerDocument2(node);
  var win = isWindow2(node) || doc.defaultView;
  return doc.body.clientWidth < win.innerWidth;
}
function isOverflowing(container) {
  var win = isWindow2(container);
...
var ModalManager = (function() {
  ...
  _proto.setContainerStyle = function setContainerStyle(containerState, container) {
    ...
    if (containerState.overflowing) {
      style3.paddingRight = parseInt(css_default2(container, "paddingRight") || "0", 10) + this.scrollbarSize + "px";
    }
    css_default2(container, style3);
  };
...
var resolveContainerRef = function resolveContainerRef2(ref) {
  ...
  if (ref == null) return ownerDocument2().body;
...
var Modal = (0, import_react21.forwardRef)(function(_ref, ref) {
  ...
  if (canUseDOM_default2 && !prevShow && show) {
  ...
  var handleShow = useEventCallback(function() {
    ...
    if (autoFocus) {
      ...
      if (modal.dialog && currentActiveElement && !contains3(modal.dialog, currentActiveElement)) {
...
// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/height.js
function height(node, client) {
  const win = isWindow(node);
  return win ? win.innerHeight : client ? node.clientHeight : offset(node).height;
}

// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/querySelectorAll.js
...
// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/matches.js
var matchesImpl2;
function matches2(node, selector) {
  if (!matchesImpl2) {
    ...
    matchesImpl2 = (n, s) => nativeMatch.call(n, s);
  }
  return matchesImpl2(node, selector);
}

// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/closest.js
function closest(node, selector, stopAt) {
  if (node.closest && !stopAt) node.closest(selector);
  let nextNode = node;
  do {
    if (matches2(nextNode, selector)) return nextNode;
    nextNode = nextNode.parentElement;
  } while (nextNode && nextNode !== stopAt && nextNode.nodeType === document.ELEMENT_NODE);
  return null;
}

// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/addEventListener.js
...
var addEventListener_default2 = addEventListener2;

// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/removeEventListener.js
...
var removeEventListener_default2 = removeEventListener2;

// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/listen.js
function listen2(node, eventName, handler, options) {
  addEventListener_default2(node, eventName, handler, options);
  return () => {
    removeEventListener_default2(node, eventName, handler, options);
  };
}
var listen_default2 = listen2;
...
// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/width.js
...
// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/scrollbarSize.js
var size2;
...
// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/hasClass.js
function hasClass(element, className) {
  if (element.classList) return !!className && element.classList.contains(className);
  return ` ${element.className.baseVal || element.className} `.indexOf(` ${className} `) !== -1;
}

// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/addClass.js
...
// ../../node_modules/react-big-calendar/node_modules/dom-helpers/esm/removeClass.js
...
var accessor$1 = import_prop_types7.default.oneOfType([import_prop_types7.default.string, import_prop_types7.default.func]);
var dateFormat = import_prop_types7.default.any;
var dateRangeFormat$6 = import_prop_types7.default.func;
var views = import_prop_types7.default.oneOfType([import_prop_types7.default.arrayOf(import_prop_types7.default.oneOf(viewNames$1)), import_prop_types7.default.objectOf(function(prop, key) {
...
var DayLayoutAlgorithmPropType = import_prop_types7.default.oneOfType([import_prop_types7.default.oneOf(["overlap", "no-overlap"]), import_prop_types7.default.func]);
var MILLI = {
  seconds: 1e3,
  minutes: 1e3 * 60,
  hours: 1e3 * 60 * 60,
...
function mergeWithDefaults(localizer, culture, formatOverrides, messages2) {
  var formats2 = _objectSpread$a(_objectSpread$a({}, localizer.formats), formatOverrides);
...
var Toolbar = (function(_React$Component) {
  function Toolbar2() {
    ...
    _this = _callSuper$f(this, Toolbar2, [].concat(args));
...
Toolbar.propTypes = true ? {
  view: import_prop_types7.default.string.isRequired,
  views: import_prop_types7.default.arrayOf(import_prop_types7.default.string).isRequired,
  label: import_prop_types7.default.node.isRequired,
  localizer: import_prop_types7.default.object,
  onNavigate: import_prop_types7.default.func.isRequired,
  onView: import_prop_types7.default.func.isRequired
} : {};
...
var EventCell = (function(_React$Component) {
  ...
  return _createClass(EventCell2, [{
    ...
    value: function render() {
      ...
      return import_react25.default.createElement(EventWrapper, _extends({}, this.props, {
        type: "date"
      }), import_react25.default.createElement("div", _extends({}, props, {
        style: _objectSpread$8(_objectSpread$8({}, userProps.style), style3),
        className: clsx_default("rbc-event", className, userProps.className, {
...
EventCell.propTypes = true ? {
  event: import_prop_types7.default.object.isRequired,
  slotStart: import_prop_types7.default.instanceOf(Date),
  slotEnd: import_prop_types7.default.instanceOf(Date),
  resizable: import_prop_types7.default.bool,
  selected: import_prop_types7.default.bool,
  isAllDay: import_prop_types7.default.bool,
  continuesPrior: import_prop_types7.default.bool,
  continuesAfter: import_prop_types7.default.bool,
...
var Popup = import_react25.default.forwardRef(function(props, ref) {
  return import_react25.default.createElement(Pop, _extends({}, props, {
    popperRef: ref
  }));
});
Popup.propTypes = {
...
function CalOverlay(_ref) {
  ...
  return import_react25.default.createElement(Overlay_default, {
    ...
    return import_react25.default.createElement(Popup, _extends({}, props, {
      containerRef,
      ref: popperRef,
      target: overlay.target,
      offset: offset3,
...
var PopOverlay = import_react25.default.forwardRef(function(props, ref) {
  return import_react25.default.createElement(CalOverlay, _extends({}, props, {
    containerRef: ref
  }));
});
...
function addEventListener3(type, handler) {
  var target = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : document;
  return listen_default2(target, type, handler, {
    passive: false
  });
}
...
var Selection = (function() {
  function Selection2(node) {
    ...
    this._removeTouchMoveWindowListener = addEventListener3("touchmove", function() {
    }, window);
    this._removeKeyDownListener = addEventListener3("keydown", this._keyListener);
    this._removeKeyUpListener = addEventListener3("keyup", this._keyListener);
    this._removeDropFromOutsideListener = addEventListener3("drop", this._dropFromOutsideListener);
    this._removeDragOverFromOutsideListener = addEventListener3("dragover", this._dragOverFromOutsideListener);
  ...
  return _createClass(Selection2, [{
    ...
    value: function _addLongPressListener(handler, initialEvent) {
      ...
      var handleTouchStart = function handleTouchStart2(initialEvent2) {
        ...
        removeTouchMoveListener = addEventListener3("touchmove", function() {
          return cleanup();
        });
        removeTouchEndListener = addEventListener3("touchend", function() {
          return cleanup();
        });
      };
      var removeTouchStartListener = addEventListener3("touchstart", handleTouchStart);
    ...
    value: function _addInitialEventListener() {
      var _this2 = this;
      var removeMouseDownListener = addEventListener3("mousedown", function(e) {
        _this2._removeInitialEventListener();
        _this2._handleInitialEvent(e);
        _this2._removeInitialEventListener = addEventListener3("mousedown", _this2._handleInitialEvent);
      });
      var removeTouchStartListener = addEventListener3("touchstart", function(e) {
        _this2._removeInitialEventListener();
    ...
    value: function _handleInitialEvent(e) {
      ...
      switch (e.type) {
        case "mousedown":
          this._removeEndListener = addEventListener3("mouseup", this._handleTerminatingEvent);
          this._onEscListener = addEventListener3("keydown", this._handleTerminatingEvent);
          this._removeMoveListener = addEventListener3("mousemove", this._handleMoveEvent);
          break;
        case "touchstart":
          this._handleMoveEvent(e);
          this._removeEndListener = addEventListener3("touchend", this._handleTerminatingEvent);
          this._removeMoveListener = addEventListener3("touchmove", this._handleMoveEvent);
          break;
      }
    }
...
var BackgroundCells = (function(_React$Component) {
  function BackgroundCells2(props, context) {
    ...
    _this = _callSuper$d(this, BackgroundCells2, [props, context]);
    _this.state = {
      selecting: false
    };
  ...
  return _createClass(BackgroundCells2, [{
    ...
    value: function render() {
      ...
      return import_react25.default.createElement("div", {
        ...
        var _getters$dayProp = getters.dayProp(date2), className = _getters$dayProp.className, style3 = _getters$dayProp.style;
        return import_react25.default.createElement(Wrapper, {
          ...
          style: style3,
          className: clsx_default("rbc-day-bg", className, selected && "rbc-selected-cell", localizer.isSameDate(date2, current) && "rbc-today", currentDate && localizer.neq(currentDate, date2, "month") && "rbc-off-range-bg")
        }));
      }));
    }
  }, {
...
BackgroundCells.propTypes = true ? {
  date: import_prop_types7.default.instanceOf(Date),
  getNow: import_prop_types7.default.func.isRequired,
  getters: import_prop_types7.default.object.isRequired,
  components: import_prop_types7.default.object.isRequired,
  container: import_prop_types7.default.func,
  dayPropGetter: import_prop_types7.default.func,
  selectable: import_prop_types7.default.oneOf([true, false, "ignoreEvents"]),
  longPressThreshold: import_prop_types7.default.number,
  onSelectSlot: import_prop_types7.default.func.isRequired,
  onSelectEnd: import_prop_types7.default.func,
  onSelectStart: import_prop_types7.default.func,
  range: import_prop_types7.default.arrayOf(import_prop_types7.default.instanceOf(Date)),
  rtl: import_prop_types7.default.bool,
  type: import_prop_types7.default.string,
  resourceId: import_prop_types7.default.any,
  localizer: import_prop_types7.default.any
} : {};
var EventRowMixin = {
  propTypes: {
...
var EventRow = (function(_React$Component) {
  function EventRow2() {
    ...
    return _callSuper$c(this, EventRow2, arguments);
  }
  ...
  return _createClass(EventRow2, [{
    ...
    value: function render() {
      ...
      var lastEnd = 1;
      return import_react25.default.createElement("div", {
        className: clsx_default(className, "rbc-row")
...
EventRow.propTypes = true ? _objectSpread$6({
...
var EventEndingRow = (function(_React$Component) {
  function EventEndingRow2() {
    ...
    return _callSuper$b(this, EventEndingRow2, arguments);
  }
  ...
  return _createClass(EventEndingRow2, [{
    ...
    value: function renderShowMore(segments, slot) {
      ...
      return count ? import_react25.default.createElement("button", {
        type: "button",
        key: "sm_" + slot,
        className: clsx_default("rbc-button-link", "rbc-show-more"),
        onClick: function onClick(e) {
...
EventEndingRow.propTypes = true ? _objectSpread$5({
  segments: import_prop_types7.default.array,
  slots: import_prop_types7.default.number,
  onShowMore: import_prop_types7.default.func
}, EventRowMixin.propTypes) : {};
...
var DateContentRow = (function(_React$Component) {
  function DateContentRow2() {
    ...
    _this = _callSuper$a(this, DateContentRow2, [].concat(args));
    ...
    _this.handleShowMore = function(slot, target) {
      ...
      var row = qsa2(_this.containerRef.current, ".rbc-row-bg")[0];
      var cell;
    ...
    _this.renderHeadingCell = function(date2, index) {
      ...
      return renderHeader({
        ...
        className: clsx_default("rbc-date-cell", localizer.isSameDate(date2, getNow2()) && "rbc-now")
      });
    };
    _this.renderDummy = function() {
      ...
      return import_react25.default.createElement("div", {
        ...
        className: clsx_default("rbc-row-content", showAllEvents && "rbc-row-content-scrollable")
  ...
  return _createClass(DateContentRow2, [{
    ...
    value: function render() {
      ...
      }, range2.map(this.renderHeadingCell)), import_react25.default.createElement(ScrollableWeekComponent, null, import_react25.default.createElement(WeekWrapper, _extends({
        isAllDay
      }, eventRowProps, {
        rtl: this.props.rtl
      }), levels.map(function(segs, idx) {
        return import_react25.default.createElement(EventRow, _extends({
          key: idx,
          segments: segs
        }, eventRowProps));
      }), !!extra.length && import_react25.default.createElement(EventEndingRow, _extends({
        segments: extra,
...
DateContentRow.propTypes = true ? {
  date: import_prop_types7.default.instanceOf(Date),
  events: import_prop_types7.default.array.isRequired,
  range: import_prop_types7.default.array.isRequired,
  rtl: import_prop_types7.default.bool,
  resizable: import_prop_types7.default.bool,
  resourceId: import_prop_types7.default.any,
  renderForMeasure: import_prop_types7.default.bool,
  renderHeader: import_prop_types7.default.func,
  container: import_prop_types7.default.func,
  selected: import_prop_types7.default.object,
  selectable: import_prop_types7.default.oneOf([true, false, "ignoreEvents"]),
  longPressThreshold: import_prop_types7.default.number,
  onShowMore: import_prop_types7.default.func,
  showAllEvents: import_prop_types7.default.bool,
  onSelectSlot: import_prop_types7.default.func,
  onSelect: import_prop_types7.default.func,
  onSelectEnd: import_prop_types7.default.func,
  onSelectStart: import_prop_types7.default.func,
  onDoubleClick: import_prop_types7.default.func,
  ...
  getters: import_prop_types7.default.object.isRequired,
  localizer: import_prop_types7.default.object.isRequired,
  minRows: import_prop_types7.default.number.isRequired,
  maxRows: import_prop_types7.default.number.isRequired
} : {};
...
DateHeader.propTypes = true ? {
  label: import_prop_types7.default.node,
  date: import_prop_types7.default.instanceOf(Date),
  drilldownView: import_prop_types7.default.string,
  onDrillDown: import_prop_types7.default.func,
  isOffRange: import_prop_types7.default.bool
} : {};
...
var MonthView = (function(_React$Component) {
  function MonthView2() {
    ...
    _this = _callSuper$9(this, MonthView2, [].concat(_args));
    _this.getContainer = function() {
    ...
    _this.readerDateHeading = function(_ref) {
      ...
      return import_react25.default.createElement("div", _extends({}, props, {
        className: clsx_default(className, isOffRange && "rbc-off-range", isCurrent && "rbc-current"),
        role: "cell"
  ...
  return _createClass(MonthView2, [{
    ...
    value: function render() {
      ...
      return import_react25.default.createElement("div", {
        className: clsx_default("rbc-month-view", className),
        role: "table",
    ...
    value: function getDerivedStateFromProps(_ref2, state) {
      ...
      return {
        date: date2,
        needLimitMeasure: state.needLimitMeasure || localizer.neq(date2, state.date, "month")
      };
    }
  }]);
})(import_react25.default.Component);
MonthView.propTypes = true ? {
  ...
  step: import_prop_types7.default.number,
  getNow: import_prop_types7.default.func.isRequired,
  scrollToTime: import_prop_types7.default.instanceOf(Date),
  enableAutoScroll: import_prop_types7.default.bool,
  rtl: import_prop_types7.default.bool,
  resizable: import_prop_types7.default.bool,
  ...
  selectable: import_prop_types7.default.oneOf([true, false, "ignoreEvents"]),
  longPressThreshold: import_prop_types7.default.number,
  onNavigate: import_prop_types7.default.func,
  onSelectSlot: import_prop_types7.default.func,
  onSelectEvent: import_prop_types7.default.func,
  onDoubleClickEvent: import_prop_types7.default.func,
  onKeyPressEvent: import_prop_types7.default.func,
  onShowMore: import_prop_types7.default.func,
  showAllEvents: import_prop_types7.default.bool,
  doShowMoreDrillDown: import_prop_types7.default.bool,
  onDrillDown: import_prop_types7.default.func,
  getDrilldownView: import_prop_types7.default.func.isRequired,
  popup: import_prop_types7.default.bool,
  handleDragStart: import_prop_types7.default.func,
  popupOffset: import_prop_types7.default.oneOfType([import_prop_types7.default.number, import_prop_types7.default.shape({
    x: import_prop_types7.default.number,
    y: import_prop_types7.default.number
...
var getKey2 = function getKey3(_ref) {
...
function noOverlap(_ref) {
  ...
  for (var _i3 = 0; _i3 < styledEvents.length; ++_i3) {
    ...
    size3 = 100 / (maxIdx + 1);
    styledEvents[_i3].size = size3;
    for (var _j3 = 0; _j3 < allFriends.length; ++_j3) allFriends[_j3].size = size3;
  }
...
var TimeSlotGroup = (function(_Component) {
  function TimeSlotGroup2() {
    ...
    return _callSuper$8(this, TimeSlotGroup2, arguments);
  }
    ...
    value: function render() {
      ...
      return import_react25.default.createElement("div", _extends({
        ...
        return import_react25.default.createElement(Wrapper, {
          ...
          value,
          resource
        }, import_react25.default.createElement("div", _extends({}, slotProps, {
          className: clsx_default("rbc-time-slot", slotProps.className)
...
TimeSlotGroup.propTypes = true ? {
  renderSlot: import_prop_types7.default.func,
  group: import_prop_types7.default.array.isRequired,
  resource: import_prop_types7.default.any,
  components: import_prop_types7.default.object,
  getters: import_prop_types7.default.object
} : {};
...
function TimeGridEvent(props) {
  var style3 = props.style, className = props.className, event = props.event, accessors = props.accessors, rtl = props.rtl, selected = props.selected, label = props.label, continuesPrior2 = props.continuesPrior, continuesAfter2 = props.continuesAfter, getters = props.getters, onClick = props.onClick, onDoubleClick = props.onDoubleClick, isBackgroundEvent = props.isBackgroundEvent, onKeyPress = props.onKeyPress, _props$components = props.components, Event2 = _props$components.event, EventWrapper = _props$components.eventWrapper;
  var title = accessors.title(event);
  var tooltip = accessors.tooltip(event);
  var end2 = accessors.end(event);
  var start2 = accessors.start(event);
  ...
  var height2 = style3.height, top2 = style3.top, width = style3.width, xOffset = style3.xOffset;
  ...
  return import_react25.default.createElement(EventWrapper, _extends({
    type: "time"
    ...
    className: clsx_default(isBackgroundEvent ? "rbc-background-event" : "rbc-event", className, userProps.className, {
      "rbc-selected": selected,
...
var DayColumnWrapper = function DayColumnWrapper2(_ref) {
  var children = _ref.children, className = _ref.className, style3 = _ref.style, innerRef = _ref.innerRef;
  return import_react25.default.createElement("div", {
    className,
    style: style3,
    ref: innerRef
...
var DayColumnWrapper$1 = import_react25.default.forwardRef(function(props, ref) {
  return import_react25.default.createElement(DayColumnWrapper, _extends({}, props, {
    innerRef: ref
  }));
});
...
var DayColumn = (function(_React$Component) {
  function DayColumn2() {
    ...
    _this = _callSuper$7(this, DayColumn2, [].concat(_args));
    _this.state = {
      selecting: false,
    ...
    _this.renderEvents = function(_ref) {
      ...
      return styledEvents.map(function(_ref2, idx) {
        ...
        var event = _ref2.event, style3 = _ref2.style;
        var end2 = accessors.end(event);
        var start2 = accessors.start(event);
  ...
  return _createClass(DayColumn2, [{
    ...
    value: function render() {
      ...
      var _dayProp = dayProp(max3, resource), className = _dayProp.className, style3 = _dayProp.style;
      ...
      return import_react25.default.createElement(DayColumnWrapperComponent, {
        ...
        className: clsx_default("rbc-events-container", rtl && "rtl")
      }, this.renderEvents({
...
DayColumn.propTypes = true ? {
  events: import_prop_types7.default.array.isRequired,
  backgroundEvents: import_prop_types7.default.array.isRequired,
  step: import_prop_types7.default.number.isRequired,
  date: import_prop_types7.default.instanceOf(Date).isRequired,
  min: import_prop_types7.default.instanceOf(Date).isRequired,
  max: import_prop_types7.default.instanceOf(Date).isRequired,
  getNow: import_prop_types7.default.func.isRequired,
  isNow: import_prop_types7.default.bool,
  rtl: import_prop_types7.default.bool,
  resizable: import_prop_types7.default.bool,
  accessors: import_prop_types7.default.object.isRequired,
  components: import_prop_types7.default.object.isRequired,
  getters: import_prop_types7.default.object.isRequired,
  localizer: import_prop_types7.default.object.isRequired,
  showMultiDayTimes: import_prop_types7.default.bool,
  culture: import_prop_types7.default.string,
  timeslots: import_prop_types7.default.number,
  selected: import_prop_types7.default.object,
  selectable: import_prop_types7.default.oneOf([true, false, "ignoreEvents"]),
  eventOffset: import_prop_types7.default.number,
  longPressThreshold: import_prop_types7.default.number,
  onSelecting: import_prop_types7.default.func,
  onSelectSlot: import_prop_types7.default.func.isRequired,
  onSelectEvent: import_prop_types7.default.func.isRequired,
  onDoubleClickEvent: import_prop_types7.default.func.isRequired,
  onKeyPressEvent: import_prop_types7.default.func,
  className: import_prop_types7.default.string,
  dragThroughEvents: import_prop_types7.default.bool,
  resource: import_prop_types7.default.any,
...
ResourceHeader.propTypes = true ? {
  ...
  resource: import_prop_types7.default.object
} : {};
...
var TimeGridHeader = (function(_React$Component) {
  function TimeGridHeader2() {
    ...
    _this = _callSuper$6(this, TimeGridHeader2, [].concat(args));
  ...
  return _createClass(TimeGridHeader2, [{
    ...
    value: function renderHeaderCells(range2) {
      ...
      return range2.map(function(date2, i) {
        ...
        var _dayProp = dayProp(date2), className = _dayProp.className, style3 = _dayProp.style;
        ...
        return import_react25.default.createElement("div", {
          key: i,
          style: style3,
          className: clsx_default("rbc-header", className, localizer.isSameDate(date2, today) && "rbc-today")
    ...
    value: function render() {
      ...
      var style3 = {};
      if (isOverflowing2) {
        style3[rtl ? "marginLeft" : "marginRight"] = "".concat(scrollbarSize2() - 1, "px");
      }
      var groupedEvents = resources.groupEvents(events);
      return import_react25.default.createElement("div", {
        style: style3,
        ref: scrollRef,
        className: clsx_default("rbc-time-header", isOverflowing2 && "rbc-overflowing")
      }, import_react25.default.createElement("div", {
...
TimeGridHeader.propTypes = true ? {
  range: import_prop_types7.default.array.isRequired,
  events: import_prop_types7.default.array.isRequired,
  resources: import_prop_types7.default.object,
  getNow: import_prop_types7.default.func.isRequired,
  isOverflowing: import_prop_types7.default.bool,
  rtl: import_prop_types7.default.bool,
  resizable: import_prop_types7.default.bool,
  width: import_prop_types7.default.number,
  localizer: import_prop_types7.default.object.isRequired,
  ...
  selectable: import_prop_types7.default.oneOf([true, false, "ignoreEvents"]),
  longPressThreshold: import_prop_types7.default.number,
  allDayMaxRows: import_prop_types7.default.number,
  onSelectSlot: import_prop_types7.default.func,
  onSelectEvent: import_prop_types7.default.func,
  onDoubleClickEvent: import_prop_types7.default.func,
  onKeyPressEvent: import_prop_types7.default.func,
  ...
  onShowMore: import_prop_types7.default.func,
  getDrilldownView: import_prop_types7.default.func.isRequired,
  scrollRef: import_prop_types7.default.any
} : {};
...
var TimeGridHeaderResources = (function(_React$Component) {
  function TimeGridHeaderResources2() {
    ...
    _this = _callSuper$5(this, TimeGridHeaderResources2, [].concat(args));
    _this.handleHeaderClick = function(date2, view, e) {
      e.preventDefault();
      notify(_this.props.onDrillDown, [date2, view]);
    };
...
TimeGridHeaderResources.propTypes = true ? {
  range: import_prop_types7.default.array.isRequired,
  events: import_prop_types7.default.array.isRequired,
  resources: import_prop_types7.default.object,
  getNow: import_prop_types7.default.func.isRequired,
...
var TimeGutter = function TimeGutter2(_ref2) {
  ...
  var renderSlot = (0, import_react25.useCallback)(function(value, idx) {
    ...
    return import_react25.default.createElement("span", {
      className: clsx_default("rbc-label", isNow && "rbc-now")
...
TimeGutter.propTypes = true ? {
  min: import_prop_types7.default.instanceOf(Date).isRequired,
  max: import_prop_types7.default.instanceOf(Date).isRequired,
  timeslots: import_prop_types7.default.number.isRequired,
  step: import_prop_types7.default.number.isRequired,
  getNow: import_prop_types7.default.func.isRequired,
  components: import_prop_types7.default.object.isRequired,
  getters: import_prop_types7.default.object,
  localizer: import_prop_types7.default.object.isRequired,
  resource: import_prop_types7.default.string,
  gutterRef: import_prop_types7.default.any
} : {};
var TimeGutter$1 = import_react25.default.forwardRef(function(props, ref) {
  return import_react25.default.createElement(TimeGutter, _extends({
    gutterRef: ref
  }, props));
});
var NONE = {};
...
var TimeGrid = (function(_Component) {
  function TimeGrid2(props) {
    ...
    _this = _callSuper$4(this, TimeGrid2, [props]);
      ...
      if (popup) {
        ...
        _this.setState({
          overlay: {
            date: date2,
            events,
            position: _objectSpread$1(_objectSpread$1({}, position2), {}, {
              width: "200px"
            }),
            target
          }
  ...
  return _createClass(TimeGrid2, [{
    ...
    value: function renderDayColumn(date2, id, resource, groupedEvents, groupedBackgroundEvents, localizer, accessors, components2, dayLayoutAlgorithm, now) {
      ...
      return import_react25.default.createElement(DayColumn, _extends({}, this.props, {
        localizer,
    ...
    value: function render() {
      ...
      return import_react25.default.createElement("div", {
        className: clsx_default("rbc-time-view", resources && "rbc-time-view-resources"),
        ref: this.containerRef
...
TimeGrid.propTypes = true ? {
  events: import_prop_types7.default.array.isRequired,
  backgroundEvents: import_prop_types7.default.array.isRequired,
  resources: import_prop_types7.default.array,
  resourceGroupingLayout: import_prop_types7.default.bool,
  step: import_prop_types7.default.number,
  timeslots: import_prop_types7.default.number,
  range: import_prop_types7.default.arrayOf(import_prop_types7.default.instanceOf(Date)),
  min: import_prop_types7.default.instanceOf(Date).isRequired,
  max: import_prop_types7.default.instanceOf(Date).isRequired,
  getNow: import_prop_types7.default.func.isRequired,
  scrollToTime: import_prop_types7.default.instanceOf(Date).isRequired,
  enableAutoScroll: import_prop_types7.default.bool,
  showMultiDayTimes: import_prop_types7.default.bool,
  rtl: import_prop_types7.default.bool,
  resizable: import_prop_types7.default.bool,
...
var Day = (function(_React$Component) {
  function Day2() {
    ...
    return _callSuper$3(this, Day2, arguments);
  }
  ...
  return _createClass(Day2, [{
    ...
    value: function render() {
      ...
      return import_react25.default.createElement(TimeGrid, _extends({}, props, {
        range: range2,
        eventOffset: 10,
        localizer,
        min: min3,
...
var Week = (function(_React$Component) {
  function Week2() {
    ...
    return _callSuper$2(this, Week2, arguments);
  }
...
Week.title = function(date2, _ref3) {
  ...
  var _Week$range = Week.range(date2, {
    localizer
  }), _Week$range2 = _toArray(_Week$range), start2 = _Week$range2[0], rest = _arrayLikeToArray$1(_Week$range2).slice(1);
...
var WorkWeek = (function(_React$Component) {
  function WorkWeek2() {
    ...
    return _callSuper$1(this, WorkWeek2, arguments);
  }
...
WorkWeek.title = function(date2, _ref) {
  ...
  var _workWeekRange = workWeekRange(date2, {
    localizer
  }), _workWeekRange2 = _toArray(_workWeekRange), start2 = _workWeekRange2[0], rest = _arrayLikeToArray2(_workWeekRange2).slice(1);
  return localizer.format({
    start: start2,
    end: rest.pop()
  }, "dayRangeHeaderFormat");
...
function Agenda(_ref) {
  ...
  var _adjustHeader = function _adjustHeader2() {
    ...
    if (isOverflowing2) {
      addClass2(header, "rbc-header-overflowing");
      header.style.marginRight = scrollbarSize2() + "px";
    } else {
      removeClass2(header, "rbc-header-overflowing");
    }
  };
  var messages2 = localizer.messages;
...
Agenda.propTypes = true ? {
  ...
  events: import_prop_types7.default.array,
  getters: import_prop_types7.default.object.isRequired,
  length: import_prop_types7.default.number.isRequired,
  localizer: import_prop_types7.default.object.isRequired,
  onSelectEvent: import_prop_types7.default.func,
  onDoubleClickEvent: import_prop_types7.default.func,
  selected: import_prop_types7.default.object
...
var Calendar = (function(_React$Component) {
  function Calendar2() {
    ...
    _this.handleNavigate = function(action, newDate) {
      ...
      var today = getNow2();
      date2 = moveDate(ViewComponent, _objectSpread(_objectSpread({}, props), {}, {
        action,
  ...
  return _createClass(Calendar2, [{
    ...
    value: function render() {
      ...
      return import_react25.default.createElement("div", _extends({}, elementProps, {
        className: clsx_default(className, "rbc-calendar", props.rtl && "rbc-rtl"),
        style: style3
        ...
        localizer
      }), import_react25.default.createElement(View, _extends({}, props, {
        events,
        backgroundEvents,
        date: current,
        getNow: getNow2,
...
Calendar.propTypes = true ? {
   ...
   *
   */
  elementProps: import_prop_types7.default.object,
  /**
   ...
   * @controllable onView
   */
  view: import_prop_types7.default.string,
  /**
   * The initial view set for the Calendar.
   * @type Calendar.Views ('month'|'week'|'work_week'|'day'|'agenda')
   * @default 'month'
   */
  defaultView: import_prop_types7.default.string,
  /**
   ...
   * ```
   */
  events: import_prop_types7.default.arrayOf(import_prop_types7.default.object),
  /**
   ...
   * ```
   */
  backgroundEvents: import_prop_types7.default.arrayOf(import_prop_types7.default.object),
  /**
   ...
   */
  resources: import_prop_types7.default.arrayOf(import_prop_types7.default.object),
  /**
   ...
   * @default () => new Date()
   */
  getNow: import_prop_types7.default.func,
  /**
   ...
   * @controllable view
   */
  onView: import_prop_types7.default.func,
  /**
   ...
   */
  onRangeChange: import_prop_types7.default.func,
  /**
   ...
   * ```
   */
  getDrilldownView: import_prop_types7.default.func,
  /**
   * Determines the end date from date prop in the agenda view
   * date prop + length (in number of days) = end date
   */
  length: import_prop_types7.default.number,
  /**
   * Determines whether the toolbar is displayed
   */
  toolbar: import_prop_types7.default.bool,
  /**
   ...
   * ```
   */
  eventPropGetter: import_prop_types7.default.func,
  /**
   * Optionally provide a function that returns an object of className or style props
   ...
   * ```
   */
  slotPropGetter: import_prop_types7.default.func,
  /**
   ...
   * ```
   */
  slotGroupPropGetter: import_prop_types7.default.func,
  /**
   * Optionally provide a function that returns an object of className or style props
   ...
   */
  formats: import_prop_types7.default.shape({
    /**
     ...
     */
    dayRangeHeaderFormat: dateRangeFormat$6,
    /**
     ...
     */
    agendaHeaderFormat: dateRangeFormat$6,
    /**
     * A time range format for selecting time slots, e.g "8:00am – 2:00pm"
     */
    selectRangeFormat: dateRangeFormat$6,
    agendaDateFormat: dateFormat,
    agendaTimeFormat: dateFormat,
    agendaTimeRangeFormat: dateRangeFormat$6,
    /**
     * Time range displayed on events.
     */
    eventTimeRangeFormat: dateRangeFormat$6,
    /**
  ...
  components: import_prop_types7.default.shape({
    event: import_prop_types7.default.elementType,
    eventWrapper: import_prop_types7.default.elementType,
    eventContainerWrapper: import_prop_types7.default.elementType,
    dateCellWrapper: import_prop_types7.default.elementType,
    dayColumnWrapper: import_prop_types7.default.elementType,
    timeSlotWrapper: import_prop_types7.default.elementType,
    timeGutterHeader: import_prop_types7.default.elementType,
    timeGutterWrapper: import_prop_types7.default.elementType,
    timeIndicatorWrapper: import_prop_types7.default.elementType,
    resourceHeader: import_prop_types7.default.elementType,
    showMore: import_prop_types7.default.elementType,
    toolbar: import_prop_types7.default.elementType,
    agenda: import_prop_types7.default.shape({
      date: import_prop_types7.default.elementType,
      time: import_prop_types7.default.elementType,
      event: import_prop_types7.default.elementType
    }),
    day: import_prop_types7.default.shape({
      header: import_prop_types7.default.elementType,
      event: import_prop_types7.default.elementType
    }),
    week: import_prop_types7.default.shape({
      header: import_prop_types7.default.elementType,
      event: import_prop_types7.default.elementType
    }),
    month: import_prop_types7.default.shape({
      header: import_prop_types7.default.elementType,
      dateHeader: import_prop_types7.default.elementType,
      event: import_prop_types7.default.elementType
    })
  }),
  /**
  ...
  messages: import_prop_types7.default.shape({
    allDay: import_prop_types7.default.node,
    previous: import_prop_types7.default.node,
    next: import_prop_types7.default.node,
    today: import_prop_types7.default.node,
    month: import_prop_types7.default.node,
    week: import_prop_types7.default.node,
    day: import_prop_types7.default.node,
    agenda: import_prop_types7.default.node,
    date: import_prop_types7.default.node,
    time: import_prop_types7.default.node,
    event: import_prop_types7.default.node,
    noEventsInRange: import_prop_types7.default.node,
    showMore: import_prop_types7.default.func
  }),
  /**
...
function moment(moment2) {
  ...
  function getDstOffset2(start2, end2) {
    ...
    var tzName = (_st$_z$name = st === null || st === void 0 || (_st$_z = st._z) === null || _st$_z === void 0 ? void 0 : _st$_z.name) !== null && _st$_z$name !== void 0 ? _st$_z$name : moment2.tz.guess();
  ...
  function lte2(a, b, unit) {
    var _defineComparators9 = defineComparators(a, b, unit), _defineComparators0 = _slicedToArray(_defineComparators9, 3), dtA = _defineComparators0[0], dtB = _defineComparators0[1], datePart = _defineComparators0[2];
    return dtA.isSameOrBefore(dtB, datePart);
  }
...
function luxon(DateTime) {
  ...
  function lte2(a, b, unit) {
    var _defineComparators9 = defineComparators(a, b, unit), _defineComparators0 = _slicedToArray(_defineComparators9, 2), dtA = _defineComparators0[0], dtB = _defineComparators0[1];
    return +dtA <= +dtB;
  }
  function inRange3(day2, min4, max4) {
    var unit = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "day";
