  ...
  return (
    <section className="relative h-[90vh] min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <img
          src="https://images.unsplash.com/photo-1663601982929-51e28aab0444?auto=format&fit=crop&w=1600&q=75"
          ...
          >
            ...
            <div className="w-full md:w-auto p-2">
              ...
              <Button
                type="submit"
                size="lg"
                className="w-full h-14 md:w-14 rounded-xl bg-primary hover:bg-primary/90 text-white shadow-brand"
              >
