...
const HostRegisterPage = () => {
  ...
  const handleVerifyOTP = async (e) => {
    ...
    setLoading(true);
    try {
      await signupWithOTP(phone, password, 'host', name, email);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-muted/30 px-4 py-12 pt-28">
      <Helmet><title>Become a Host | TakeOn BnB</title></Helmet>
      
      <Card className="w-full max-w-md shadow-xl border-border rounded-2xl overflow-hidden">
        <CardHeader className="text-center pb-6 bg-secondary-gradient text-white">
          <CardTitle className="text-3xl font-extrabold tracking-tight">Become a Host</CardTitle>
