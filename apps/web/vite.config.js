...
import previewAuthPlugin from './plugins/vite-plugin-preview-auth.js';
...
export default defineConfig({
	...
	customLogger: logger,
	plugins: [
		...(isDev ? [inlineEditPlugin(), editModeDevPlugin(), selectionModePlugin(), iframeRouteRestorationPlugin(), previewAuthPlugin()] : []),
		react(),
