...
const UPIPaymentDisplay = ({ amount, upiId, merchantName }) => {
  ...
  return (
    <div className="flex flex-col items-center w-full space-y-6">
      <QRCodeGenerator amount={amount} upiId={upiId} merchantName={merchantName} />
      ...
      <Button 
        ...
        className="w-full h-14 text-lg font-bold rounded-xl shadow-lg bg-gradient-to-r from-primary to-orange-500 hover:from-primary/90 hover:to-orange-500/90 text-white hover:-translate-y-1 transition-all duration-300"
      >
