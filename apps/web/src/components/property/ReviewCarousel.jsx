...
import { getHostAvatarUrl, getHostName } from '@/lib/propertyMappers.js';
      ...
      >
        <CarouselContent className="-ml-4">
          {reviews.map((review, index) => {
            ...
            const guestName = getHostName(guest) || 'Verified Guest';
            const guestAvatar = getHostAvatarUrl(guest) || `https://api.dicebear.com/7.x/initials/svg?seed=${guestName}`;
              ...
              <Card className="h-full bg-[#F5F2EC] border-none shadow-sm hover:shadow-md transition-shadow">
                <CardContent className="p-6 flex flex-col h-full">
                  ...
                  <div className="flex items-center gap-4 mt-auto pt-4 border-t border-border/50">
                    ...
                    <div>
                      <h5 className="font-semibold text-sm">{guestName}</h5>
