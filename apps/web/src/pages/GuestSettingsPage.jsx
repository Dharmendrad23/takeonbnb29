    ...
    <GuestDashboardLayout>
      ...
      >
        <TabsList className="bg-card border border-border p-1 rounded-xl w-full sm:w-auto flex flex-wrap h-auto mb-8 shadow-sm">
          ...
          <TabsTrigger
            value="profile"
            className="rounded-lg flex-1 sm:flex-none font-semibold"
          >
          ...
          <div className="bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm max-w-2xl">
            ...
            >
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full sm:w-auto h-12 px-8 rounded-xl font-bold bg-primary hover:bg-primary/90 text-primary-foreground shadow-brand mt-4"
              >
                {loading ? (
                  <>
        ...
        >
          <div className="bg-card border border-border rounded-3xl p-6 md:p-8 shadow-sm max-w-2xl">
            ...
            <Button
              variant="outline"
              className="h-12 px-6 rounded-xl font-bold border-border hover:bg-muted"
            >
              Change Password
            </Button>
