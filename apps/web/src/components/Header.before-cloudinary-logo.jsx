...
//             src="https://res.cloudinary.com/bfmmvn4z/image/upload/v1787818167/WhatsApp_Image_2026-08-27_at_13.38.54.jpg"
      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center group">
          <img
            src="https://res.cloudinary.com/bfmmvn4z/image/upload/v1787818167/WhatsApp_Image_2026-08-27_at_13.38.54.jpg"
            alt="Take on BnB"
            className="h-[70px] md:h-[50px] w-auto max-w-[220px] object-contain object-left transition-transform group-hover:scale-105"
          />
        </Link>
