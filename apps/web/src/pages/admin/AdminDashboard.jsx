          ...
          <div className="space-y-5 flex-1">
            {recentBookings.length === 0 ? (
              ...
              recentBookings.map(booking => {
                ...
                return (
                  <div key={booking._id} className="flex items-start justify-between group">
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-[10px] text-muted-foreground mt-1 uppercase tracking-wider">{formatDate(booking.createdAt)}</p>
                    </div>
