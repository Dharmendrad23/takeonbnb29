...
const PropertyDetailPage = () => {
  ...
  const images = useMemo(() => {
    ...
    const source = Array.isArray(property.photos)
      ? property.photos
      : [];
  ...
  const rating = Number(
    property?.rating || property?.averageRating || 0
  );
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <Heart
                  className={
                    liked
                      ? "h-5 w-5 fill-[#E8750A] text-[#E8750A]"
                      : "h-5 w-5"
                  }
                />
              </Button>
                ...
                <div className="mb-3 flex flex-wrap items-center gap-2">
                  ...
                  {rating > 0 && (
                    <span className="flex items-center gap-1 text-sm font-bold">
                      <Star
                        className="h-4 w-4 fill-[#E8750A] text-[#E8750A]"
                      />
                      {rating.toFixed(1)}
                    </span>
                  )}
          ...
          <section className="grid items-start gap-7 xl:grid-cols-[minmax(0,1fr)_390px] xl:gap-9">
            <div className="min-w-0">
              ...
              <section className="mb-5 rounded-[26px] border border-gray-200 bg-white p-6 md:p-8">
                ...
                {amenities.length ? (
                  <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
                    {amenities.slice(0, 16).map((amenity, index) => {
                      const name =
                      ...
                      return (
                        ...
                        >
                          <CheckCircle2
                            className="mb-3 h-5 w-5 text-[#E8750A]"
                          />
              ...
              <section className="mb-5 rounded-[26px] border border-gray-200 bg-white p-6 md:p-8">
                ...
                <div
                  className="relative mt-6 flex h-[260px] items-center justify-center overflow-hidden rounded-3xl border border-gray-200"
                  style={{
                    background:
                      "linear-gradient(135deg,#FFF4E5,#ffffff,#f3f4f6)",
                  }}
                >
              ...
              <section className="mb-8 rounded-[26px] border border-gray-200 bg-white p-6 md:p-8">
                <div className="mb-6 flex items-center gap-3">
                  ...
                  >
                    <Star
                      className="h-6 w-6 fill-[#E8750A] text-[#E8750A]"
                    />
                  </div>
