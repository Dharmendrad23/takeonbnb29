  ...
  return (
    <section className="relative h-[90vh] min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mt-16">
        ...
        >
          <form className="flex flex-col md:flex-row items-center gap-2 divide-y md:divide-y-0 md:divide-x divide-border/50" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="w-full md:w-1/3 p-3 flex items-center gap-3">
              ...
              <div className="flex-1 flex text-left gap-4">
                <div className="flex-1">
                  ...
                  <input type="date" className="w-full bg-transparent border-none p-0 text-foreground font-medium focus:ring-0 cursor-pointer" />
                </div>
                <div className="flex-1">
            ...
            <div className="w-full md:w-1/4 p-3 flex items-center gap-3">
              ...
              <div className="flex-1 text-left">
                ...
                <select className="w-full bg-transparent border-none p-0 text-foreground font-medium focus:ring-0 cursor-pointer">
